...
class AttendanceController
{
    public function attendanceIn()
    {
        ...
        if (isset($submitPressed)) {
            ...
            $wsResponse = Utility::curl_post(ApiService::ADD_IN_URL, $sendData);
        ...
        $result = json_decode($wsResponse);
        include_once 'pages/attendance_page.php';
    }
    ...
    public function attendanceOut()
    {
        ...
        if (isset($submitPressed)) {
            ...
            $wsResponse = Utility::curl_post(ApiService::ADD_OUT_URL, $sendData);
            $inputStatus = json_decode($wsResponse);
